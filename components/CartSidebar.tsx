  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 max-w-full flex md:pl-10">
        <div className="w-screen md:max-w-md h-full flex flex-col bg-white shadow-2xl">
          ...
          {items.length > 0 && (
            <div className="border-t border-slate-100 p-6 bg-white shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.05)] z-20 sticky bottom-0">
