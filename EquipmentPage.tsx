...
const EquipmentPage: React.FC<EquipmentPageProps> = ({ onBack, cartCount, onOpenCart, onOpenTracking, onOpenSearch, onAddToCart, products, socialLinks, onOpenTender }) => {
  ...
  const handleAddToCart = () => {
    if (selectedProduct && !isAddDisabled) {
      onAddToCart(selectedProduct, selColor, undefined, selStyle, instructions);
              ...
              <div className="space-y-12">
                ...
                <div className="space-y-4">
                  ...
                  <textarea
                    ...
                    placeholder="e.g. Please calibration preferences, or specific delivery handling..."
                    className="w-full px-8 py-6 bg-slate-50 border border-slate-100 rounded-[2rem] text-sm font-bold text-black focus:ring-4 focus:ring-sky-500/10 focus:border-sky-600 outline-none transition-all resize-none"
                    rows={3}
                  />
                </div>
